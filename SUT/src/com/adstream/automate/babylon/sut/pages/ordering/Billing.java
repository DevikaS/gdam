 ...
 */
public class Billing extends PageElement<OrderProceedPage> {
    private String subTotal;
    private String tax;
    private String total;

    public Billing(ExtendedWebDriver web, OrderProceedPage parent, WebElement billingData) {
        super(web, parent);
    ...
    private By generateBillingPartsLocator(String partialLocator) {
        return By.cssSelector(OrderProceedPage.billingProps + " " + partialLocator);
    }
