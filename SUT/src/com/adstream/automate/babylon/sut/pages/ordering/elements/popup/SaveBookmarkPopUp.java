...
/*
 * Created by demidovskiy-r on 13.05.14.
 */
public class SaveBookmarkPopUp extends AbstractPopUp {
    public final static String TITLE = "Save bookmark";
    public final static String TITLE_NODE = generateTitleNode(TITLE);

    public SaveBookmarkPopUp(OrderItemPage parentPage, String title) {
