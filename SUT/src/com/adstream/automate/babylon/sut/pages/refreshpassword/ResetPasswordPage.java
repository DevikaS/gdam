...
public class ResetPasswordPage extends BasePage {
    public ResetPasswordPage(ExtendedWebDriver web) {
        super(web);
    }
    ...
    @Override
    public void load() {
        web.waitUntilElementAppearVisible(By.cssSelector("[ng-app='resetPassword']"));
    }

    @Override
    public void isLoaded() throws Error {
        assertTrue(web.isElementPresent(By.cssSelector("[ng-app='resetPassword']")));
    }
