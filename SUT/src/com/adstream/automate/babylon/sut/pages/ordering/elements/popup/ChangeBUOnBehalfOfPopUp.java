...
/*
 * Created by demidovskiy-r on 12.02.2015.
 */
public class ChangeBUOnBehalfOfPopUp extends AbstractPopUp {
    public final static String TITLE = "Change Client";
    ...
    public ChangeBUOnBehalfOfPopUp(OrderItemPage parentPage, String title) {
    ...
    public ChangeBUOnBehalfOfPopUp selectOnBehalfOfBU(String agencyName) {
        onBehalfOfBU.selectByVisibleText(agencyName);
        return new ChangeBUOnBehalfOfPopUp((OrderItemPage)parentPage,  title);
    }

    public ChangeBUOnBehalfOfPopUp selectInvoiceOnBehalfOfBU(String agencyName) {
