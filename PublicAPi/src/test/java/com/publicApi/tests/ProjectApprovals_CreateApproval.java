 ...
 */
public class ProjectApprovals_CreateApproval extends ProjectsBaseTest {

    @Test
    public void createProjectApproval() throws IOException {
        ...
        Assert.assertNotNull(responsePayLoad.getApproval().get_id(), this.getClass().getSimpleName().toUpperCase()+": End Point Failed due to, ");
