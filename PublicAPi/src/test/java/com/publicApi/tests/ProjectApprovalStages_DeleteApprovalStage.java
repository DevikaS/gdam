 ...
 */
public class ProjectApprovalStages_DeleteApprovalStage extends ProjectsBaseTest {

    @Test
    public void deleteProjectApprovalStage() throws IOException {
        ...
        Assert.assertTrue(apiCall.projectDeleteApprovalStage(getApproverId(), getStageId()),
