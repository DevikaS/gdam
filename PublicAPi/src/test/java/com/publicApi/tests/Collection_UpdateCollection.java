 ...
 */
public class Collection_UpdateCollection extends LibraryBaseTests {
    ...
    public void updateCollectionTest() {
        ...
        //Update collection with filters
        responsePayLoad = apiCall.updateCollection(getCollectionId());
