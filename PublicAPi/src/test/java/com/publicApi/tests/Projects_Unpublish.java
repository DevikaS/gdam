 ...
 */
public class Projects_Unpublish extends ProjectsBaseTest {

    @Test
    public void projectUnPublishTest() {
        ...
        Assert.assertTrue(responsePayLoad.getMeta().getCommon().isPublished(),
                this.getClass().getSimpleName().toUpperCase()+": Check Publish project status");


        responsePayLoad = apiCall.unpublishProject(getProjectId());
