...
public class Order_EditItem extends OrdersBaseTest{
    ...
    public void editItemTest() {
        ...
        responsePayLoad = apiCall.editItem(getOrderId(), getItemId());
...
//			actual_list.add(responsePayLoad.getMeta().getAsset().getDictionaryMetaData().getAdvertiser()[0].toString());
        ...
        expected_list.add(ExpectedData.SUBTITLESREQUIRED_EDIT);
