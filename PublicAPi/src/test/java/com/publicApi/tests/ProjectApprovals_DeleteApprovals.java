 ...
 */
public class ProjectApprovals_DeleteApprovals extends ProjectsBaseTest {

    @Test
    public void deleteProjectApproval() throws IOException {
        ...
        Assert.assertTrue(apiCall.projectDeleteApproval(getMediaId(), getFileId(), getApproverId()),
