 ...
 */
public class Relations_DeleteRelation extends ProjectsBaseTest {
    ...
    public void deleteRelationTest() {
        ...
        setRelationID(responsePayLoad.get_id());

        //Delete Relation
        Assert.assertTrue(apiCall.deleteRelation(getRelationID()),
