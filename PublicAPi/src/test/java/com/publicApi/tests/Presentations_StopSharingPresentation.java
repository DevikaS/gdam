 ...
 */
public class Presentations_StopSharingPresentation extends LibraryBaseTests {

    @Test
    public void stopSharingPresentationTest() {
        ...
        // Stop sharing
        Assert.assertTrue(apiCall.stopSharingPresentation(getPresentationId()),
                this.getClass().getSimpleName().toUpperCase()+": End Point Failed due to, ");
    }
}
