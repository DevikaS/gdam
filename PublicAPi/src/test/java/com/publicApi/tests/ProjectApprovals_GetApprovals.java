 ...
 */
public class ProjectApprovals_GetApprovals extends ProjectsBaseTest {

    @Test
    public void getProjectApproval() throws IOException {
        ...
        responsePayLoad=apiCall.projectGetApproval(getMediaId(), getFileId());
