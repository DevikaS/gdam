...
public class Order_GetItem extends OrdersBaseTest{
	...
	public void getItemTest() {
		...
		String responseStr = apiCall.getItem(getOrderId(), getItemId());
		ResponseParser.updateActualItemList(responseStr, actual_list);
