...
/**
 * Created by Devika on 21/12/2016.
 */
public class ProjectApprovalStages_CreateApprovalStage extends ProjectsBaseTest {

    @Test
    public void createProjectApprovalStage() throws IOException {
        ...
        Assert.assertNotNull(responsePayLoad.getStage().getStageId(), this.getClass().getSimpleName().toUpperCase() + ": End Point Failed due to, ");
        Assert.assertNotNull(responsePayLoad.getStage().getName(), this.getClass().getSimpleName().toUpperCase() + ": End Point Failed due to, ");
    }

    @Test
    public void createProjectApprovalStage_WithDeadlineDate() throws IOException {
        ...
        responsePayLoad=apiCall.projectCreateApprovalStage(getApproverId(),true,"WaitAll");
        Assert.assertNotNull(responsePayLoad.getStage().getStageId(), this.getClass().getSimpleName().toUpperCase() + ": End Point Failed due to, ");
        Assert.assertNotNull(responsePayLoad.getStage().getName(), this.getClass().getSimpleName().toUpperCase() + ": End Point Failed due to, ");
    }
}
