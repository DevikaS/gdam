 ...
 */
public class Asset_EditAttachment extends LibraryBaseTests {

    @Test
    public void editAttachmentTest() throws IOException {
        ...
        responsePayLoad=apiCall.assetCreateAttachment(getAssetId(), getMediaID(), getMediaName(), getMediaSize());
        setAttachId(responsePayLoad.getId());

        //Edit Attachment
        responsePayLoad = apiCall.assetEditAttachment(getAssetId(), getAttachId(), getMediaID(), getMediaName(), getMediaSize());
