 ...
 */
public class ProjectApprovals_StartApproval extends ProjectsBaseTest {

    @Test
    public void projectStartApproval() throws IOException {
        ...
        Assert.assertEquals(responsePayLoad.getApproval().getStatus(), ExpectedData.PROJECT_STATUS_BEFOREAPPROVAL, this.getClass().getSimpleName().toUpperCase() + ": End Point Failed due to, ");
