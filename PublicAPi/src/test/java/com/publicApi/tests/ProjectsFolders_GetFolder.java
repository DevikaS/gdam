 ...
 */
public class ProjectsFolders_GetFolder extends ProjectsBaseTest {

    @Test
    public void projectsFolders_GetFolder() {
        ...
        responsePayLoad=apiCall.projectsFoldersGetFolder(getFolderId());
