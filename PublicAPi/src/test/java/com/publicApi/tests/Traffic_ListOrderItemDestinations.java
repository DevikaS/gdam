 ...
 */
public class Traffic_ListOrderItemDestinations extends OrdersBaseTest {


    @Test
    public void Traffic_ListOIDestinations() {
        ...
        Traffic response = apiCall.traffic_ListOrderItemDestinations(getItemId());
