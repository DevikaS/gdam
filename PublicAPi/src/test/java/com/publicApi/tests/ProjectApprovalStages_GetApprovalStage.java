 ...
 */
public class ProjectApprovalStages_GetApprovalStage extends ProjectsBaseTest {

    @Test
    public void getProjectApprovalStage() throws IOException {
        ...
        Assert.assertEquals(responsePayLoad.getStage().getStageId(), getStageId(), this.getClass().getSimpleName().toUpperCase() + ": End Point Failed due to, ");
