 ...
 */
public class Attachments_ListAttachments extends ProjectsBaseTest{

    @Test
    public void listAttachments_FilesTest() throws IOException {
        ...
        //List Attachments
        responsePayLoad=apiCall.listAttachments("files", getFileId());
    ...
    @Test
    public void listAttachments_AssetsTest() throws IOException {
        apiCall = new HeadlessAPICalls();
        ...
        //List Attachments
        responsePayLoad=apiCall.listAttachments("assets", getAssetId());
