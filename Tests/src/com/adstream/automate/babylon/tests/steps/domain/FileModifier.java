...
public class FileModifier {
    ...
    public FileModifier(File fileObject) throws Exception {
     ...
     */
    public FileModifier(String absoluteFilename) {
     ...
     * @param value
     */
    public FileModifier(String absoluteFilename, boolean value) {
